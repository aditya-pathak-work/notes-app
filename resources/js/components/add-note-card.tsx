...
export default function AddNoteCard() {
    return (
        <Card className="group cursor-pointer select-none h-45 hover:scale-103 ease-linear transition hover:shadow-md justify-center items-center " onClick={() => router.get("/notes/new")}>
